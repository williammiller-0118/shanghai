...
export default function ThirdMasterPage() {
    ...
    useEffect(() => {
        ...
        let result = splitTextByLetterCount(text, 1100);
        let text1 = result[1];
        // setPart([result[0]])
        ...
        let res3 = splitTextByLetterCount(secondText, 780);
        let text4 = res3[1]
        ...
        <div className="flex lg:flex-row flex-col h-screen p-[2rem] gap-[2rem]" style={{ height: "100%", overflowY: "auto" }}>
            ...
            <div className="flex flex-row flex-1 gap-[1rem] lg:w-1/2">
                ...
                <div className="flex flex-col items-center justify-center flex-1 gap-[1rem]">
                    <div className="flex flex-1 text-justify" style={{ height: "calc(100% - 25dvw * 9 / 16)" }}>
                        <div className={styles.mainBody}>
                            {part[4]}
                        </div>
                    </div>
