      ...
      <div className={styles.bookLayout}>
        ...
        <div className="relative">
          ...
          <section className="absolute w-full h-screen overflow-hidden">
            ...
            >
              <source src="/videos/Shanghai landscape cover no button 4k.mp4" media="(min-width: 769px)" type="video/mp4" />
              <source src="/videos/Shanghai landscape cover no button 4k.mp4" media="(max-width: 768px)" type="video/mp4" />
